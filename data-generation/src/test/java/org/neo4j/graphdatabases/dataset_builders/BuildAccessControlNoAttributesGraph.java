...
@Ignore
public class BuildAccessControlNoAttributesGraph
{
    ...
    {
        File dir = new File( AccessControlNoAttributes.STORE_DIR );
        ...
        GraphDatabaseService db = new EmbeddedGraphDatabase( AccessControlNoAttributes.STORE_DIR, params );
        ...
        NodeSpecification customerSpec = dsm.nodeSpecification( "employee", indexableProperty( "name", "employee", "resource" ) );
        NodeSpecification accountSpec = dsm.nodeSpecification( "account", indexableProperty( "name", "account", "resource" ) );
        ...
        NodeCollection administrators = adminSpec.create( AccessControlNoAttributes.NUMBER_OF_ADMINS ).update( dataset );
        NodeCollection groups = administrators.createRelationshipsTo(
                getOrCreate( groupSpec, AccessControlNoAttributes.NUMBER_OF_GROUPS )
        ...
        NodeCollection companies1allowedInherit = groups.createRelationshipsTo(
                getOrCreate( companySpec, percentageOf( AccessControlNoAttributes.NUMBER_OF_COMPANIES, 0.17 ) )
        ...
        NodeCollection companies1allowedDoNotInherit = groups.createRelationshipsTo(
                        getOrCreate( companySpec, percentageOf( AccessControlNoAttributes.NUMBER_OF_COMPANIES, 0.08 ) )
                                .numberOfTargetNodes( ALLOWED_COMPANIES_PER_GROUP )
        ...
        NodeCollection companies1denied = groups.createRelationshipsTo(
                getOrCreate( companySpec, percentageOf( AccessControlNoAttributes.NUMBER_OF_COMPANIES, 0.1 ) )
        ...
        NodeCollection companies2allowedInherit = groups.createRelationshipsTo(
                getOrCreate( companySpec, percentageOf( AccessControlNoAttributes.NUMBER_OF_COMPANIES, 0.33 ) )
                        .numberOfTargetNodes( ALLOWED_COMPANIES_PER_GROUP )
                        .relationship( allowed_inherit )
                        .relationshipConstraints( RelationshipUniqueness.BOTH_DIRECTIONS ) )
                .update( dataset );
        ...
        NodeCollection companies2denied = groups.createRelationshipsTo(
                getOrCreate( companySpec, percentageOf( AccessControlNoAttributes.NUMBER_OF_COMPANIES, 0.15 ) )
                        .numberOfTargetNodes( DENIED_COMPANIES_PER_GROUP )
                        .relationship( denied )
                        .relationshipConstraints( RelationshipUniqueness.BOTH_DIRECTIONS ) )
                .update( dataset );

        NodeCollection companies1 = companies1allowedInherit.combine( companies1allowedDoNotInherit ).combine( companies1denied );
        NodeCollection companies2 = companies2allowedInherit.combine( companies2allowedDoNotInherit ).combine( companies2denied );
